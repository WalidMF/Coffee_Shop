...
<head>
    ...
    <title>Coffee Shop - Category</title>
...
<body>
    ...
    <div class="m-0 p-3 h-100 w-100 d-flex">
        ...
        <div class="main_section_style m-0 p-3 ">
            <!-- <h1 class="text-start ">Add Category</h1> -->
            <div class="container mt-5">
                <div class="row">
                    <div class="col-8 mt-5 pt-5 d-flex justify-content-center">
                        <form method="post" action="form_cat.php" class="mt-5 w-50" enctype="multipart/form-data">
                            <h3>Add Category...</h3>
                           
                            <div class="mb-4 mt-4">
                                <label for="name" class="fs-6">Category</label>
                                <br>
                                <input type="text" class="form-control" id="name" placeholder="Enter Category Name" name="category" required>
                            </div>
                            <button type="submit" class="btn btn-primary" name="save">Save</button>
                            
                        </form>
                    </div>
                    <div class="col-4 mt-3 pt-5 d-flex justify-content-start">
