            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-8 mt-5 pt-5 d-flex justify-content-center">
                        <form method="post" action="form_cat.php" class="mt-5" enctype="multipart/form-data">
                            <h1>Add Category</h1>
                           
                            <div class="mb-4 mt-4">
                                <label for="name" class="fs-5">Category Name</label>
                                <br>
                                <input type="text" class="form-control" id="name" placeholder="Enter product.." name="category" required>
                            </div>
